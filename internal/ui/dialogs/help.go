...
// Init initializes the help dialog. It does not return any command
func (h *help) Init() tea.Cmd {
	return nil
}

// SetBindings sets the key bindings for the help dialog.
func (h *help) SetBindings(k []key.Binding) {
	h.keys = k
}

// Update updates the help dialog. It currently only handles window size messages
