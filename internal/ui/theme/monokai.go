...
// MonokaiPro is a theme that implements the Theme interface.
type MonokaiPro struct {
	Default
}

// NewMonokaiPro creates a new Monokai Pro theme with the official color palette.
func NewMonokaiPro() *MonokaiPro {
...
func init() {
	...
	RegisterTheme("monokai", NewMonokaiPro())
}
