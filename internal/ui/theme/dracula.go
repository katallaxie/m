...
// Dracula is a theme that implements the Theme interface.
type Dracula struct {
	Default
}

// NewDracula creates a new Dracula theme with the official color palette.
...
func init() {
	...
	RegisterTheme("dracula", NewDracula())
}
